...
export const SandboxContent = ({ className, ...props }: SandboxContentProps) => <CollapsibleContent className={cn('outline-none data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:slide-out-to-top-2 data-[state=open]:animate-in data-[state=open]:slide-in-from-top-2', className)} {...props} />;
...
export const SandboxTabsBar = ({ className, ...props }: SandboxTabsBarProps) => <div className={cn('flex w-full items-center border-t border-b border-border', className)} {...props} />;
...
export const SandboxTabsTrigger = ({ className, ...props }: SandboxTabsTriggerProps) => <TabsTrigger className={cn('rounded-none border-0 border-b-2 border-transparent px-4 py-2 text-sm font-medium text-muted-foreground transition-colors data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:shadow-none', className)} {...props} />;
