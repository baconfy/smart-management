                        ...
                        <div className="flex w-full items-stretch overflow-hidden rounded-xl border border-border">
                            {!manualSetupKey ? (
                                ...
                                <>
                                    ...
                                    />
                                    <button onClick={() => copy(manualSetupKey)} className="clickable border-l border-border px-3 hover:bg-muted">
...
function TwoFactorVerificationStep({ onClose, onBack }: { onClose: () => void; onBack: () => void }) {
    ...
    return (
        <Form action={confirm.url()} method="post" onSuccess={() => onClose()} resetOnError resetOnSuccess>
            {({ processing, errors }) => (
